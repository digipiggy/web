<template>
  ...
  >
    ...
    >
      ...
      <v-container >
        <v-row>
          <v-col cols="4">
            <v-img 
              :src="require(`@/assets/${lessonPage.quoteImg}`)"
              :lazy-src="require(`@/assets/${lessonPage.quoteImg}`)"  
    ...
    <!--Arrow at the bottom of the page with link to next page-->
